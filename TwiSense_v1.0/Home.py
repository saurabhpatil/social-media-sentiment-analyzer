...
#   Set parameters for rendering of bar graph using highcharts.js
#   Obtain string of all tweets with their respective sentiment and
#   pass on both the parameter dictionary and tweets to calling function
...
#   Open the specified url in a new tab in your default web browser and
#   run the flask python application on the same port
